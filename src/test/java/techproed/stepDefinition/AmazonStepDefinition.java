...
public class AmazonStepDefinition {
    ...
    //Önemli sag tarafta Maven'a tikla Proje'den Lifecycle'i secip install'a sag tiklayip, sonrasinda Execute before Build'e tikla
    //Build(cekic) yapmak projeyi derliyor, yapmazsan proje'de baglantida bazen hata olabiliyor
}