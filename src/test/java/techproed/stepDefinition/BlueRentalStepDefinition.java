...
public class BlueRentalStepDefinition {
    ...
    public void kullaniciTablodaVerilenBilgilerIleLoginOlur(DataTable data) {
        ...
        Driver.getDriver().navigate().back();//Burada normalde stale element hatasi(bayatlamis element) alirdik
        //Fakat bir yere tiklamadigimiz icin sadece veri girisi yaptigimiz icin bu hatayi almadik.
